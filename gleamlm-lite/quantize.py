"""GleamLM-Lite 87M 量化导出。FP32 → FP16，体积减半，推理精度基本无损。

用法：
    python gleamlm-lite/quantize.py
    python gleamlm-lite/quantize.py --input checkpoints/best_model.pt --output checkpoints/model_fp16.pt
...
def main() -> None:
    parser = argparse.ArgumentParser(description="GleamLM-Lite 87M FP16 量化导出")
    parser.add_argument(
        "--input", type=str,
