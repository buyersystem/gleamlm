...
用法：
    ...
    # 首次标注
    python data_tools/pretrain/score.py --input data/lite/pretrain/train.txt --sample 5000

    # 断点续标（追加到已有标注，跳过已标注的文本）
    python data_tools/pretrain/score.py --input data/lite/pretrain/train.txt --sample 5000 --resume

    # 训分类器 + 全量评分
    python data_tools/pretrain/score.py --input data/lite/pretrain/train.txt --train --score
"""
