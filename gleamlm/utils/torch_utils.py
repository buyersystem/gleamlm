...
def get_lr_cosine(step: int, total_steps: int, warmup_ratio: float = 0.01,
...
def get_lr_wsd(step: int, total_steps: int, warmup_ratio: float = 0.02,
               stable_ratio: float = 0.80, min_lr_ratio: float = 0.05) -> float:
