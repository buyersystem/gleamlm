...
parser.add_argument('--path', type=str, default='checkpoints/best_model.pt',
...
if 'args' in ckpt:
    a = ckpt['args']
    print(f'd_model={a.d_model}, layers={a.num_layers}, heads={a.num_heads}, kv_heads={a.num_kv_heads}, d_ff={a.d_ff}, vocab={a.vocab_size}')
