...
m40 = GleamLMModel(vocab_size=12002, d_model=512, num_layers=12, num_heads=8, num_kv_heads=4,
...
print("\n=== 87M (flash_attn=True) ===")
m87 = GleamLMModel(vocab_size=12002, d_model=768, num_layers=12, num_heads=12, num_kv_heads=6,
